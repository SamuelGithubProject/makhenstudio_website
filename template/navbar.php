      ...
      <ul class="navbar-nav navbar-center mx-auto">
        ...
        <?php if (isset($_SESSION['level_user']) && isset($_SESSION['logged_stat'])) : ?>
          ...
          <?php elseif ($session == "Admin") : ?>
            <li class="nav-item text-center">
              <a class="nav-link" aria-current="page" href="?page=datatim"><i class="fas fa-users"></i> Data Tim</a>
            </li>
            <li class='nav-item text-center'>
              <a class='nav-link' aria-current='page' href='?page=datapemesanan'><i class='fas fa-shopping-cart'></i> Data Pesanan</a>
            </li>
            <li class="nav-item text-center">
              <a class="nav-link" aria-current="page" href="?page=datalaporan"><i class="fas fa-clipboard-list"></i> Laporan</a>
            </li>
          <?php endif ?>
        <?php else : ?>
          <li class="nav-item text-center">
